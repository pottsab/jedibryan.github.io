...
".",".",".",
"MESSAGE RECOVERED:<style1><br />congratulations jedi bryan","you have received a powerful ancient device that can re-align the rare kyber crystal to reflect shades of light.",
"in order to shift the crystal's colors, set the device",
"frequency to 125khz and write these codes to the crystal",
"and behold the power of your lightsaber and unlock the",
"vast library of data contained in your holocron.</style1>",
"<br /><br />Translating to: ENGLISH...","",
"<br /><style2>Congratulations Jedi Bryan,",
"You have received a powerful ancient device that can re-align the properties of any kyber crystal to reflect different shades of light.",
"In order to shift the crystal's colors, set the device frequency to 125KHz and write these codes to the crystal and behold the power of your lightsaber and unlock the vast library of data contained in your holocron.",
"Be careful using this tool and protect your mind from the pull of the dark side.</style2>","",
